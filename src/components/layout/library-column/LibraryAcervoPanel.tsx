...
export function LibraryAcervoPanel({
  ...
  return (
    <div
      ...
      hidden={hidden}
    >
      <div className="flex flex-col gap-2 shrink-0 border-b border-[#353535] pb-2">
        <div className="flex gap-0.5 bg-[#363636]">
          <select
        ...
        {mediaCategory === 'musics' && (
          <div className="flex flex-col gap-2 border border-[#353535]/80 rounded-lg px-3 py-2 mx-2 bg-black/15">
        ...
        <div className="flex items-center gap-2 bg-white/3 border border-[#353535] rounded-lg px-3 mx-2 py-1.5">
          <span className="text-[0.85rem] opacity-70" aria-hidden>
            🔍
          </span>
          <input
            id="buscaMidia"
            className="flex-1 bg-transparent border-none outline-none text-white/90 text-[0.85rem] placeholder:text-slate-500"
