  ...
  return (
    <div className="flex h-12 shrink-0 items-center gap-3 border-b-4 border-[#353535] px-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <svg id="reload-playlist" className="reloadplaylistcommand cursor-pointer" xmlns="http://www.w3.org/2000/svg" width={32}
          height={32} viewBox="0 0 500 500">
          <path fill="white" id="Shape_1_copy" data-name="Shape 1 copy" className="cls-1"
