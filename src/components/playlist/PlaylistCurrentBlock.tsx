    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
          ...
          className="lucide lucide-list-chevrons-up-down playlist-compact-icon playlist-compact-icon-compact shrink-0"
          aria-hidden="true">
          <path d="M3 5h8" />
          <path d="M3 12h8" />
          <path d="M3 19h8" />
        ...
        <DraggableCommandIcon commandId="cmd-pause" label="Pausa">
          <svg className="shrink-0" xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px"
            fill="#e3e3e3">
            <path
